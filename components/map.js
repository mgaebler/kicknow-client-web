...
export default class MapArea extends React.Component {
  ...
  constructor(props) {
    ...
    this.customMarkerIcon = L.icon({
      ...
      iconRetinaUrl: require('../images/marker@2x.png'),
      iconSize: [25, 46],
      iconAnchor: [12, 46],
      popupAnchor: [0, -46]
    });
  ...
  componentDidMount(){
    ...
    this.refs.mapContainer
      .addEventListener('webkitTransitionEnd', this.adjustMap.bind(this))
    ;
  ...
  */
  ...
  render(){
    ...
    let controlZoomClass = (this.state.canvas == 'small')? 'glyphicon glyphicon-resize-full':'glyphicon glyphicon-resize-small';
